// Video Options Menu Component - Based on React's components/VideoOptionsMenu.js
// Displays menu of actions for a video (save, follow, share, website)
// CLEAN: Uses hooks for business logic, pure UI component
...
import '../app/videoOptionsStyles.css'

interface VideoOptionsMenuProps {
    video: Video & { companies?: { name: string; website?: string } }
 ...
 * Based on React's VideoOptionsMenu.js (110 lines)
 */
export default function VideoOptionsMenu({ video, currentUser, onClose }: VideoOptionsMenuProps) {
    // Use custom hooks for ALL business logic (like React)
    ...
    } = useCompanyFollow(video.companies?.name || '', currentUser)
